    ...
    <div class="container">
                                ...
                                if ($invoiceAmount > 0) {
                                    ...
                                    if ($order["total_amount"] != '') {
                                        ...
                                        <td colspan="3">
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#myModal">' . $order["transaction_id"] . '</a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title" id="myModalLabel">' . $order["transaction_id"] . '</h4>
                                                    </div>
                                                    <div class="modal-body">';


                                        $jsonTransaction = json_decode($order["transaction_data"]);

                                        foreach ($jsonTransaction as $tran_key => $tran_val) {
                                            echo '<div class="row">
                                                            <div class="col-sm-12 form-control" style="margin-bottom: 5px">
                                                                <div class="col-sm-6">
                                                                    ' . $tran_key . '
        ...
        <div class="row" style="padding-bottom: 20px">
            <div class="col-sm-12" style="text-align: right">
                ...
                <button type="button" class="btn btn-danger btn-bordered"
                        onclick="location.href='/admin/deleteOrder/<?php echo $job; ?>';" style="margin: 0 20px">
                ...
                if ($order["status"] == 5) {
                    echo '<button type="button" class="btn btn-danger btn-bordered"
                        onclick="location.href=\'/admin/cancelOrder/' . $job . '\';" style="margin: 0 20px">
                    ' . ($lang == 'bn' ? '<span class="bangla">' . $lang_order_cancel[$lang] . '</span>' : $lang_order_cancel[$lang]) . '
                    </button>';
                } elseif ($order["status"] == 1 || $order["status"] == 2) {
                    echo '<button type="button" class="btn btn-success btn-bordered"
                        onclick="location.href=\'/admin/approveOrder/' . $job . '\';" style="margin: 0 20px">
                    ' . ($lang == 'bn' ? '<span class="bangla">' . $lang_order_approve[$lang] . '</span>' : $lang_order_approve[$lang]) . '
                    </button>';
                }

...
$page_title = $lang_ticket_safari_menu[$lang];

require_once 'header.php';


$tickets = $DB->sql("SELECT ticket_id, unique_id, ticket_name, ticket_position, ticket_price, status FROM `ticket` WHERE ticket_category = 'safariTicket'", 0, 0, 0);
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 parentTab">
                ...
                <button class="btn btn-icon btn-success addNew" onclick="location.href='/admin/addSafariTicket';">
                        ...
                        if (count($tickets) > 0) {
                            ...
                            foreach ($tickets as $ticket) {
                                echo '<tr>
                                        ...
                                        <td>
                                            <button class="btn btn-icon btn-primary" style="padding:3px 6px" onclick="location.href=\'/admin/editSafariTicket/' . $ticket["unique_id"] . '\';"><i class="fa fa-pencil"></i></button>
                                            <button class="btn btn-icon btn-danger" style="padding:3px 6px" onclick="location.href=\'/admin/deleteSafariTicket/' . $ticket["unique_id"] . '\';"><i class="fa fa-trash"></i></button>
                                        </td>
                                    </tr>';
                            }

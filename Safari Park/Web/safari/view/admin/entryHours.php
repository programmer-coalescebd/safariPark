...
$shifts = $DB->sql("SELECT * FROM shift WHERE ticket_category = 'entryTicket'", 0, 0, 0);
?>
<div class="row">
    <div class="col-sm-12 parentTab">
        ...
        <button class="btn btn-icon btn-success addNew" onclick="location.href='/admin/addEntryHour';">
                ...
                if (count($shifts) > 0) {
                    ...
                    foreach ($shifts as $shift) {
                        echo '<tr>
                                        ...
                                        <td>' . $shift["tickets"] . '</td>
                                        <td>
                                            <button class="btn btn-icon btn-danger" style="padding:3px 6px" onclick="location.href=\'/admin/deleteEntryHours/' . $shift["unique_id"] . '\';"><i class="fa fa-trash"></i></button>
                                        </td>
                                    </tr>';
                    }

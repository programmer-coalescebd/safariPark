...
!function (a) {
    ...
    var Renderer = function (a, b, c, d) {
        ...
        }, editor = renderer.create('<div class="note-editor bangla note-frame panel panel-default"/>'),
        ...
        airEditor = renderer.create('<div class="note-editor bangla"/>'),
    ...
    $.summernote = $.summernote || {lang: {}}, $.extend($.summernote.lang, {
        "en-US": {
            ...
            image: {
                image: 'ছবি',
                insert: 'ছবি যোগ করুন',
                resizeFull: 'পূর্ণ আকার',
                resizeHalf: 'অর্ধ আকার',
                resizeQuarter: 'একচতুর্থাংশ',
                floatLeft: 'বাম',
                floatRight: 'ডান',
                floatNone: 'কিছু না',
                shapeRounded: 'গোলাকার',
                shapeCircle: 'বৃত্ত',
                shapeThumbnail: 'ছোট',
                shapeNone: 'কিছু না',
                dragImageHere: 'ছবি এখানে টানুন',
                dropImage: 'ছবি এখানে রাখো',
                selectFromFiles: 'ফাইল থেকে নির্বাচন করুন',
                maximumFileSize: 'সর্বোচ্চ ফাইল সাইজ',
                maximumFileSizeError: 'সর্বোচ্চ ফাইলের আকার ত্রুটি',
                url: 'ছবির লিঙ্ক',
                remove: 'ছবি অপসারণ'
            },
            video: {
                ...
                insert: 'ভিডিও যোগ করুন',
                url: 'ভিডিও লিঙ্ক',
                providers: '(YouTube, Vimeo, Vine, Instagram, DailyMotion ou Youku)'
            },
            link: {
                link: 'লিঙ্ক',
                insert: 'লিঙ্ক যোগ করুন',
                unlink: 'লিঙ্ক অপসারণ',
                edit: 'লিঙ্ক পরিবর্তন',
                textToDisplay: 'লেখা',
                url: 'লিঙ্ক',
                openInNewWindow: 'নতুন পাতা'
            },
            table: {
                table: 'টেবিল'
            },
            ...
            lists: {
                unordered: 'তালিকা',
                ordered: 'সংখ্যা তালিকা'
            },
            options: {
                help: 'সাহায্য',
                fullscreen: 'পূর্ণ পর্দা',
                codeview: 'HTML কোড দেখুন'
            },
            paragraph: {
                paragraph: 'অনুচ্ছেদ',
                outdent: 'সংভৃতক',
            ...
            color: {
                recent: 'সাম্প্রতিক রঙ',
                more: 'আরো রঙ',
                background: 'পটভূমি',
                foreground: 'পুরোভূমি',
                transparent: 'স্বচ্ছ',
                setTransparent: 'স্বচ্ছ রাখো',
                reset: 'রিসেট',
                resetToDefault: 'ডিফল্ট রিসেট করুন'
            },
            shortcut: {
                shortcuts: 'শর্টকাট',
                close: ' বদ্ধ',
                textFormatting: 'পাঠ্য বিন্যাস',
                action: 'প্রক্রিয়া',
                paragraphFormatting: 'অনুচ্ছেদ বিন্যাস',
                documentStyle: 'নথি শৈলী',
                extraKeys: 'অতিরিক্ত কী'
            },
            history: {
                undo: 'পূর্বাবস্থায় ফিরাইয়া আনা',
                redo: 'পুনরায় করা'
            },
            help: {
                insertParagraph: "অনুচ্ছেদ যোগ",
